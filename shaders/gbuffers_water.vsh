/*
 * Surface-Stable Fractal Dithering - Water Vertex Shader
 * 
 ...
 * 
 * Description: Vertex shader for water/translucent blocks (includes waterfalls)
 */
...
varying vec3 worldNormal;  // Surface normal for UV projection
